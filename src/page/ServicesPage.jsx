...
const ServicesPage = () => {
    ...
    return (
        <div>
            <div className="flex flex-col md:flex-row justify-center items-center my-2 space-y-3 md:space-y-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 py-5 p-5">
                {
